...
const steps = [
  { n: "1", t: "Выбираете машину и работы", d: "От класса машины зависят цена и время на подъёмнике." },
...
export function Booking() {
  ...
  return (
    <Section
      ...
      lead="Онлайн-запись работает круглосуточно. Предоплату не берём, смету согласуем до начала работ."
    >
