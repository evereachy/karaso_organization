...
const DB_NAME = process.env.MONGODB_DB ?? "karosa";
...
const defaultSettings = {
  workingHours: [
    { weekday: 1, open: "08:00", close: "19:00" },
    { weekday: 2, open: "08:00", close: "19:00" },
    { weekday: 3, open: "08:00", close: "19:00" },
    { weekday: 4, open: "08:00", close: "19:00" },
    { weekday: 5, open: "08:00", close: "19:00" },
    { weekday: 6, open: "09:00", close: "15:00" },
...
const defaultMasters = [
  { id: "pavel", name: "Павел", role: "Диагност, электрика", active: true, serviceIds: ["diagnostics", "ac"], weekdaysOff: [0] },
  { id: "roman", name: "Роман", role: "Ходовая, тормоза", active: true, serviceIds: ["brakes", "suspension", "tires"], weekdaysOff: [0] },
  { id: "viktor", name: "Виктор", role: "Универсал", active: true, serviceIds: [], weekdaysOff: [3] },
];
